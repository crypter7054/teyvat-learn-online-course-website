...
<body>
    ...
    <div class="flex flex-row h-full">
        ...
        <div class="flex flex-col items-center py-6 w-full">
            <form action="<?php echo base_url() ?>/admin/save" method="post" class="sm:w-[42%] rounded-lg pt-6 px-12 w-full border" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <!-- NAMA COURSE -->
                    ...
                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                      <div class="space-y-1 text-center">
                        ...
                        <div class="flex text-sm text-gray-600 font-medium">
                          <label for="photo_admin" class="text-black relative cursor-pointer rounded-md font-medium flex flex-row items-center pl-16 my-2">
                            <input id="cupload" name="cupload" type="file" required>
                        </div>
