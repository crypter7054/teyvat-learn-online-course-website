...
<head>
    ...
    <title><?php echo "Update Course - {$course['nama_course']}" ?></title>
...
<body>
    ...
    <div class="flex flex-row h-full">
        ...
        <div class="flex flex-col mx-10 w-full sm:w-4/5 items-center py-2 px-8" id="yess">
            <h1 class="text-3xl font-medium text-neutral-600 py-4">Update Course</h1>


        <div class="flex flex-col items-center py-6 w-full">
            <?php $course; $ini = $course['photo_course'];  ?>
            <form action="<?php echo base_url() ?>/admin/save/<?= $course['id_course']; ?>" method="post" class="sm:w-[42%] rounded-lg pt-6 px-12 w-full border" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <!-- NAMA COURSE -->
                <label for="nama_course" class="block mt-5">
                    ...
                    <input name="nama_course" type="text"  id="nama_course" value="<?= $course['nama_course'] ?>" class="mt-3 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md text-sm focus:ring-1">
                </label>
                ...
                <textarea name="description" id="description" cols="40" rows="3" class="mt-3 px-2 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"><?= $course['description'] ?></textarea>
                ...
                <label for="price" class="block mt-5">
                    ...
                    <input name="price" type="number" min="0" id="price" value="<?= $course['price'] ?>" class="mt-3 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md text-sm focus:ring-1">
                </label>
                ...
                <label for="category" class="block mt-5">
                    ...
                    <input name="category" type="text"  id="category" value="<?= $course['category'] ?>" class="mt-3 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md text-sm focus:ring-1">
                </label>
                ...
                <label for="videos" class="block mt-5">
                    ...
                    <input name="videos" type="number" min="0" id="videos" value="<?= $course['videos'] ?>" class="mt-3 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md text-sm focus:ring-1">
                </label>
                ...
                <label for="instructor" class="block mt-5">
                    ...
                    <input name="instructor" type="text"  id="instructor" value="<?= $course['instructor'] ?>" class="mt-3 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md text-sm focus:ring-1">
                </label>
                ...
                <div class="w-full">
                    ...
                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                      <div class="space-y-1 text-center max-w-[80%] max-h-[80%]">
                        <div class="w-full flex rounded-lg">
                            <img src='<?php echo base_url('public/file/'.$ini); ?>' class='w-full h-full pb-4 rounded-b-md opacity-80 hover:scale-105 hover:opacity-100 duration-200 delay-50'>
                        </div>
                        <div class="flex text-sm text-gray-600 font-medium">
                            <label for="photo_admin" class="text-black relative cursor-pointer rounded-md font-medium flex flex-row items-center my-2">
                            <input id="cupload" name="cupload" type="file">
                        </div>
                ...
                <div class="flex flex-row mt-8 pb-12 w-full">
                    ...
                    <div class="bg-white w-full">
                      <button name="update_course" type="submit" id="update_course" class="inline-flex justify-center py-2 px-4 w-full border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-sky-500 hover:bg-sky-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500"> 
                        Update
                      </button>
                    </div>
