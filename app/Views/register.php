...
<body>
    ...
    <div class="flex flex-col py-24 items-center">
        <form action="<?php echo base_url() ?>/user/save" method="post" class="mt-10 shadow-lg rounded-xl  p-10 md:w-1/3 sm:w-5/6">
            <h1 class="text-3xl text-gray-600 font-normal pb-10 text-center"> Register Account </h1>
            
            <div class="flex flex-col lg:flex-row w-full justify-between">
                <!-- FNAME -->
                <label for="fname" class="flex flex-col lg:w-[46%] mt-2">
                    <span class="after:content-['*'] after:ml-0.3 after:text-red-500 text-sm font-medium text-slate-700"> First Name </span>
                    <input name="fname" type="text" placeholder="First name" required class="w-full mt-3 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 rounded-md sm:text-sm focus:ring-1">
                </label>
                
                <!-- LNAME -->
                <label for="lname" class="flex flex-col lg:w-[46%] mt-6 lg:mt-2">
                    <span class="after:content-['*'] after:ml-0.3 after:text-red-500 text-sm font-medium text-slate-700"> Last Name </span>
                    <input name="lname" type="text" placeholder="Last name" required class="w-full mt-3 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 rounded-md sm:text-sm focus:ring-1">
                </label>
            </div>
            ...
            <!-- BUTTON -->
            <div class="flex flex-row mt-8 w-full py-3">
