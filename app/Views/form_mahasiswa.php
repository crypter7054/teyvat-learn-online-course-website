...
<body class="bg-white">
    ...
    <div class="flex flex-col mt-24 mx-36 border items-center mb-9 p-8">
        <h1 class="text-2xl font-medium text-neutral-600">Tambah Data Mahasiswa</h1>

        <div class="flex flex-col items-center py-6 w-full">
            <form action="<?php echo base_url() ?>/mahasiswa/save" method="post" class="w-1/3">
                <!-- NIM -->
                <label for="tnim" class="block mt-4">
                    ...
                    <input name="tnim" type="number" maxlength="11" id="tnim" required placeholder="2009929" class="mt-3 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md text-sm focus:ring-1">
                </label>
                ...
                <label for="tnama_mahasiswa" class="block mt-5">
                    ...
                    <input name="tnama_mahasiswa" type="text"  id="tnama_mahasiswa" required placeholder="Nama anda" class="mt-3 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md text-sm focus:ring-1">
                </label>
                ...
                <label for="tkelas" class="block mt-5">
                    ...
                    <input name="tkelas" type="text" id="tkelas" required placeholder="C2" class="mt-3 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md text-sm focus:ring-1">
                </label>
                ...
                <label for="talamat" class="block mt-1">
                    ...
                    <input name="talamat" type="text"  id="talamat" required placeholder="Bandung" class="mt-3 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md text-sm focus:ring-1">
                </label>
